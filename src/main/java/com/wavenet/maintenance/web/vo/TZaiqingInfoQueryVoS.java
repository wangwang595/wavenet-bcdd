...
@ApiModel(value = " TZaiqingInfoQueryVoS对象", description = "险情信息表查询参数")
public class TZaiqingInfoQueryVoS implements Serializable {
    ...
    @ApiModelProperty(value = "灾难类别")
    @TableField("S_CD_VALUE")
    private String sCdValue;

    @ApiModelProperty(value = "派单情况")
    @TableField("XQSTATE")
