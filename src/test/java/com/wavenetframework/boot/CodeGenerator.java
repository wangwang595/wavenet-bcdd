...
import com.wavenetframework.boot.generator.config.SpringBootPlusMySqlQuery;
import lombok.Data;
...
public class CodeGenerator {
     ...
     * 包名称
     */
    private String packageController = "web";

    /**
     * entity包名称
     */
    private String packageEntity = "dao.entity";

    /**
     * mapper包名称
     */
    private String packageMapper = "dao.mapper";

    /**
     * query包名称
     */
    private String packageQuery = "web.query";
     ...
     */
    public void init() {
        this.commonParentPackage = this.commonParentPackage + ".common";
        // 父类包路径
    ...
    public void generator() {
        ...
        gc.setIdType(IdType.UUID);     // 主键类型:ID_WORKER
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                // 查询参数包路径
                String queryParamPackage = parentPackage + StringPool.DOT + pc.getModuleName() + "web.query";
                ...
                // 响应结果包路径
                String queryVoPackage = parentPackage + StringPool.DOT + pc.getModuleName() + "web.vo";
        ...
        if (generatorQueryParam) {
            focList.add(new FileOutConfig("/templates/queryParam.java.vm") {
                @Override
                public String outputFile(TableInfo tableInfo) {
                    return projectPath + "/src/main/java/" + projectPackagePath + "/" + pc.getModuleName() + "/web/query/" + tableInfo.getEntityName() + "QueryParam" + StringPool.DOT_JAVA;
                }
            });
        }
        ...
        if (generatorQueryVo) {
            focList.add(new FileOutConfig("/templates/queryVo.java.vm") {
                @Override
                public String outputFile(TableInfo tableInfo) {
                    return projectPath + "/src/main/java/" + projectPackagePath + "/" + pc.getModuleName() + "/web/vo/" + tableInfo.getEntityName() + "QueryVo" + StringPool.DOT_JAVA;
                }
            });
        }
